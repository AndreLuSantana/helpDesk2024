package com.andredev.helpdesk.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFoundError (ObjectNotFoundException ex, HttpServletRequest request){
